...
0- O programa para modelagem a ser aberto e o rentPricesModel.R - abra-o no programa de interesse (VSCode, Rstudio, etc). Para abrir o relatorio, acesse o "LH_CD_BERNARDOTURCI.Rmd" ou "LH_CD_BERNARDOTURCI.html"
